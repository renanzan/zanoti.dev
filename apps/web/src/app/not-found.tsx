...
export const metadata: Metadata = {
	title: "Página não encontrada · Renan Zanoti",
...
const Error404 = () => (
	<div
		className={clsx("background-grid flex h-full items-center justify-center")}
	>
		<div
			className={clsx(
		...
		>
			<h1 className={clsx("py-12 text-center")}>
				...
				<div className={clsx("text-2xl")}>Página não encontrada</div>
			</h1>
