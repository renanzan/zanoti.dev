...
// 	const { generateMetadata } = await import("@/helpers/seo");
// 	const project = getProjectById("conecta-platform");

// 	return generateMetadata({
// 		title: project?.title || "Plataforma Conecta",
// 		description: project?.description || "Plataforma principal para gestão de projetos sociais",
// 		path: "/projects/conecta-platform"
// 	});
// }

export default function ConectaPlatformPage() {
	const project = getProjectById("conecta-platform");
