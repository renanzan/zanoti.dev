...
export async function generateMetadata() {
	...
	const project = getProjectById("autopilot-saas");

	return generateMetadata({
		title: project?.title || "AutoPilot SaaS",
		description:
			project?.description || "Reconstrução do SaaS de automação de marketing",
		path: "/projects/autopilot-saas"
	});
}

export default function AutoPilotSaaSPage() {
	const project = getProjectById("autopilot-saas");
